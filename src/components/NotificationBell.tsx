...
interface Notification {
  ...
  is_read: boolean; is_urgent: boolean; created_at: string; task_id: string | null;
}
    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="ghost" size="icon" className="relative">
          ...
          {unread > 0 && (
            <span className={`absolute top-1 right-1 inline-flex min-w-[18px] h-[18px] items-center justify-center rounded-full px-1 text-[10px] font-bold ${
