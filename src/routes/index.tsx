        ...
        <div className="mx-auto max-w-7xl px-6 pt-20 pb-28 relative">
          ...
          >
            ...
            <p className="mt-6 max-w-xl text-lg text-muted-foreground leading-relaxed">
              Chrono-Dashboard, blocker escalation, team chat, and analytics — all wired to a real
              backend, not a sticky note.
            </p>
            <div className="mt-10 flex flex-wrap gap-3">
              <Button
                asChild
                size="lg"
                className="bg-gold-shine text-[oklch(0.16_0.02_75)] hover:opacity-90 font-semibold elevated"
              >
                <Link to="/signup">
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-14 grid md:grid-cols-3 gap-5">
            {features.map((f) => (
              <div
                key={f.title}
                className="group rounded-xl border border-border/60 surface p-6 hover:border-primary/40 transition"
              >
...
const features = [
  {
    ...
    desc: "Day, week, month — click any slot to schedule a task. Drag-friendly, deadline-aware.",
  },
  {
    icon: Bell,
    title: "Blocker escalation",
    desc: "Blocked tasks fire urgent alerts to the creator and every admin. Audible. Inescapable.",
  },
  {
    icon: Users,
    title: "Teams",
    desc: "Admins create teams, add members by email. Per-team data scopes.",
  },
  {
    icon: BarChart3,
    title: "Analytics",
    desc: "7-day completion trend, status pie, peer leaderboard. Personal + team.",
  },
  {
    icon: MessageSquare,
    title: "Realtime chat",
    desc: "Auto-created team channels with instant message delivery.",
  },
  {
    icon: Shield,
    title: "Role-based access",
    desc: "Admins vs team members enforced at the database layer with RLS.",
  },
];
